...
- The work is the picture. Transport chrome is text-only. It appears on hover/move or tap, then fades after 3s — desktop and phone. Using a control or the id box resets the timer; resting the mouse on the toolbar keeps it up; leaving the mouse on the plate does not.
