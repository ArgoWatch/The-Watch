...
- Relic twins (Gold vs None, same other slots) from the trait snapshot. Catalog number is a 1px-offset door to the corresponding print; the differing stud cell answers to hover/long-press. Not a 2-pixel Hamming on tokenURI (stamps would break it). Fate frames have no twin door.
