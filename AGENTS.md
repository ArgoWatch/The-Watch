...
- Twins from the trait snapshot, exclusive pairs only. Relic (Gold vs None) first — the stud cell is the proof. Then Sight **Shades vs Glasses** only (same 23-cell frame, the #85/#708 rhyme); no pulse on the lenses. Not Dior/LV/3D/patch, not a Hamming rule. Relic wins if both exist. Fate frames have no twin door.
