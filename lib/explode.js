(function (global) {
  ...
  function gridFromSvg(svgText) {
    ...
    rects.forEach(function (r) {
      // ACK print stamps and fainter #000/#fff grit (wool dust) are not solid trait paint.
      if (isPrintStamp(r) || (TS.decode.isFaintInk && TS.decode.isFaintInk(r))) return;
  ...
  TS.explode = { bind: bind, HARBOR: HARBOR, traitDiffCells: traitDiffCells };
})(window);
